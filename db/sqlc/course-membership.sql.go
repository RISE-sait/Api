...
const createCourseMembership = `-- name: CreateCourseMembership :one
INSERT INTO course_membership (course_id, membership_id, price_per_booking, is_eligible)
VALUES ($1, $2, $3, $4)
RETURNING course_id, membership_id, price_per_booking, is_eligible
`
...
func (q *Queries) CreateCourseMembership(ctx context.Context, arg CreateCourseMembershipParams) (CourseMembership, error) {
	row := q.db.QueryRowContext(ctx, createCourseMembership,
		arg.CourseID,
		arg.MembershipID,
		arg.PricePerBooking,
		arg.IsEligible,
...
const deleteCourseMembership = `-- name: DeleteCourseMembership :exec
...
func (q *Queries) DeleteCourseMembership(ctx context.Context, arg DeleteCourseMembershipParams) error {
	_, err := q.db.ExecContext(ctx, deleteCourseMembership, arg.CourseID, arg.MembershipID)
	return err
}
...
const updateCourseMembership = `-- name: UpdateCourseMembership :exec
...
func (q *Queries) UpdateCourseMembership(ctx context.Context, arg UpdateCourseMembershipParams) error {
	_, err := q.db.ExecContext(ctx, updateCourseMembership,
		arg.CourseID,
		arg.MembershipID,
		arg.PricePerBooking,
		arg.IsEligible,
